...
if __name__ == "__main__":
    ...
    # Create a figure showing the candidate value across the WakeMap domain, as well as showing
    # the existing farm and the candidate locations (where the candidate value is evaluated)
